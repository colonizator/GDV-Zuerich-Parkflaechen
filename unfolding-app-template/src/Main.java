...
public class Main extends PApplet {
	...
	public void initDistrictMap() {
		this.districtMap = new UnfoldingMap(this, "districtMap", 0, SPACING_TOP, width / 3, height);
	...
	public void initNatureMapA() {
		this.natureMapA = new UnfoldingMap(this, "natureMapA", width / 3 + SPACING_MAP_WIDTH, SPACING_TOP, width / 3,
				this.detailsMapHeight - (SPACING_MAP_HEIGHT / 2));
	...
	public void initNatureMapB() {
		this.natureMapB = new UnfoldingMap(this, "natureMapB", width / 3 * 2 + 2 * SPACING_MAP_WIDTH, SPACING_TOP,
	...
	public void initParkingMapA() {
		this.parkingMapA = new UnfoldingMap(this, "parkingMapA", width / 3 + SPACING_MAP_WIDTH,
				SPACING_TOP + this.detailsMapHeight + (SPACING_MAP_HEIGHT / 2), width / 3,
				this.detailsMapHeight - (SPACING_MAP_HEIGHT / 2));
	...
	public void initParkingMapB() {
		this.parkingMapB = new UnfoldingMap(this, "parkingMapB", width / 3 * 2 + 2 * SPACING_MAP_WIDTH,
				SPACING_TOP + this.detailsMapHeight + (SPACING_MAP_HEIGHT / 2), width / 3,
				this.detailsMapHeight - (SPACING_MAP_HEIGHT / 2));
	...
	public void loadDistricts() {
		...
		List<Marker> districts = loadMarkers("zurich_bezirke_nopoints.geojson", color(100, 100, 100, 127),
	...
	public void loadParks() {
		this.parkMarkersA = loadMarkers("zurich_parks.geojson", color(0, 170, 0, 127), color(0, 230, 0, 127));
		this.parkMarkersB = loadMarkers("zurich_parks.geojson", color(0, 170, 0, 127), color(0, 230, 0, 127));
	}

	public void loadGrass() {
		this.grassMarkersA = loadMarkers("zurich_grasflaechen.geojson", color(0, 220, 0, 127), color(0, 255, 0, 127));
		this.grassMarkersB = loadMarkers("zurich_grasflaechen.geojson", color(0, 220, 0, 127), color(0, 255, 0, 127));
	}

	public void loadForest() {
		this.forestMarkersA = loadMarkers("zurich_waldflaechen.geojson", color(0, 70, 15, 127), color(0, 200, 40, 127));
		this.forestMarkersB = loadMarkers("zurich_waldflaechen.geojson", color(0, 70, 15, 127), color(0, 200, 40, 127));
	}
	 ...
	 * for(Marker marker : markers) { markerManager.removeMarker(marker); } }
	 * 
	 * public void removeAllMarkersMapA() { removeMarkers(this.natureMapA,
	 * this.parkMarkersA); removeMarkers(this.natureMapA, this.grassMarkersA);
	 * removeMarkers(this.natureMapA, this.forestMarkersA);
	 * removeMarkers(this.parkingMapA, this.parkingMarkersA); }
	 * 
	 * public void removeAllMarkersMapB() { removeMarkers(this.natureMapB,
	 * this.parkMarkersB); removeMarkers(this.natureMapB, this.grassMarkersB);
